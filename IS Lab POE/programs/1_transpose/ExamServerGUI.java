...
public class ExamServerGUI extends JFrame {
    ...
    private void handleClient(Socket client) {
        new Thread(() -> {
            try (BufferedReader in = new BufferedReader(new InputStreamReader(client.getInputStream()));
                ...
                int shift = 3;
                String encryptedQP = transposeEncrypt(qpContent, shift);
                appendLog("QP encrypted with transpose Cipher :  shift=" + shift);
    ...
    // STUDENT CUSTOMIZE: Transpose Cipher Encryption (shift >0 for encrypt)
