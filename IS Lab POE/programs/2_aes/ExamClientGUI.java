...
public class ExamClientGUI extends JFrame {
    ...
    private void decryptAndDownload() {
        try {
            ...
            String decrypted = aesDecrypt(encryptedQP);
    ...
    private String aesDecrypt(String text) {
        try {
            // Ensure you are using the static method from your aesUtil class
            return AESUtil.decrypt(text);
        } catch (Exception e) {
            e.printStackTrace(); // Print the error to the console so you can see why aes failed
